...
import { User, SkillCategory } from './src/types';
import { Users, Search, Filter, Code, Palette, Phone, Database, Layout, Briefcase, LineChart, Loader, Link2 } from 'lucide-react';
import {  MessageCircle, LogOut, Edit, ChevronDown, ChevronUp, Star, Gamepad, Video, Megaphone, Pen, DollarSign, Glasses, Wifi,  Cloud, Server, Shield, Brain } from 'lucide-react';
