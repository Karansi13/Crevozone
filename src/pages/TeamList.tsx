...
import { Users, MessageCircle, LogOut, Trash2, X, Loader } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <h1 className="text-2xl font-bold mb-4 sm:mb-0">Your Teams</h1>
            ...
            {teams.map((team) => (
              ...
              >
                <div className="w-full sm:w-auto">
                  ...
                  <div className="mt-1 flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-2">
                    <span className="text-sm text-gray-500">
                      {team.members.length} members
                    </span>
                    {team.createdBy === user?.uid && (
                      <span className="text-sm text-blue-600 bg-blue-50 px-2 py-0.5 rounded sm:ml-2">
                        Team Leader
                      </span>
                    )}
                  </div>
